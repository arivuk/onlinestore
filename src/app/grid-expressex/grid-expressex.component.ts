...
@Component({
  selector: 'app-grid-expressex',
  templateUrl: './grid-expressex.component.html',
  styleUrls: ['./grid-expressex.component.css']
})
export class GridExpressexComponent implements OnInit {
  companies: Company[]
  constructor() { }
